...
<div class="container">
    <ul class="nav nav-pills nav-fill">
        ...
        <li class="nav-item">
            <a class="nav-item nav-link" id="defaultTab" data-toggle="tab" href="#orderTab" role="tab">Orders</a>
        </li>
        <li class="nav-item">
            <a class="nav-item nav-link" data-toggle="tab" href="#serviceTab" role="tab">Existing services</a>
        </li>
        <li class="nav-item">
            <a class="nav-item nav-link" data-toggle="tab" href="#priceTab" role="tab">Pricing</a>
        </li>
    ...
    <div class="modal fade" id="priceAddModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
